...
export const setLocale = locale => ({ type: "CONFIGURATION_SET_LOCALE", payload: locale });
...
export const requestChannels = category => ({
  type: "CHANNELS_FETCH_REQUESTED",
  payload: category,
});
...
export const setSearchChannels = message => ({
  type: "SEARCH_CHANNELS_FETCH_SUCCESS",
  payload: message.data,
});
export const setSearchChannelsFilters = filters => ({
  type: "SEARCH_CHANNELS_SET_FILTERS",
  payload: filters,
});

export const setSearchBots = message => ({
  type: "SEARCH_BOTS_FETCH_SUCCESS",
  payload: message.data,
});
export const setSearchBotsFilters = filters => ({
  type: "SEARCH_BOTS_SET_FILTERS",
  payload: filters,
});

export const setSearchStickers = message => ({
  type: "SEARCH_STICKERS_FETCH_SUCCESS",
  payload: message.data,
});
export const setSearchStickersFilters = filters => ({
  type: "SEARCH_STICKERS_SET_FILTERS",
  payload: filters,
});
...
export const requestChannelVerification = username => ({
  type: "CHANNEL_VERIFICATION_REQUESTED",
  username,
});
export const setChannelVerificationSuccess = () => ({ type: "CHANNEL_VERIFICATION_SUCCESS" });
export const setChannelVerificationError = error => ({
  type: "CHANNEL_VERIFICATION_FAIL",
  payload: error,
});
